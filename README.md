...
- **Ultrasonic sensors** (DFRobot URM37 V5.0) for close-range obstacle avoidance and parking alignment
...
| DFRobot URM37 V5.0 (×2) | 5V | ~40mA each | Via 5V rail |
...
**DFRobot URM37 V5.0 Ultrasonic Sensors (SEN0001) (2 units) — front-left and front-right**

The URM37 V5.0 provides accurate distance readings between 2cm and 800cm with built-in temperature compensation, which keeps measurements stable when the venue heats up under competition lighting. We use two sensors angled ~30° outward from center to give a wide forward detection cone. These are the primary close-range sensors for obstacle avoidance and for measuring parking zone alignment during the parallel parking maneuver. Ultrasonic sensors were preferred over IR sensors because the WRO track uses colored walls that can confuse infrared reflectance.
...
| DFRobot URM37 V5.0 Ultrasonic Sensor (SEN0001) | 2 | Close-range obstacle/parking distance | [DigiKey](https://www.digikey.com/en/products/detail/dfrobot/SEN0001/6588449) |
...
| 1 | ESP32 WROOM-32 — ~$8 | [Amazon](https://www.amazon.com/dp/B08D5ZD528) |
...
| 2 | DFRobot URM37 V5.0 Ultrasonic Sensor (SEN0001) — $13.90 each | [DigiKey](https://www.digikey.com/en/products/detail/dfrobot/SEN0001/6588449) |
...
| DFRobot URM37 V5.0 (SEN0001) (×2) | Close-range obstacle detection and parking alignment |
